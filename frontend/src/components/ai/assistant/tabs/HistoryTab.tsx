...
export function HistoryTab() {
  return (
    <div style={{
      ...
      <span style={{ font: 'var(--ai-w-ui) 13px/1.4 var(--ai-font)', color: 'var(--p-text-body)' }}>History · Coming soon</span>
      <span style={{ font: 'var(--ai-w-body) 11.5px/1.5 var(--ai-font)' }}>Past conversations will appear here once enabled.</span>
    </div>
  );
}
