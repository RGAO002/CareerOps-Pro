"""
Pydantic schemas for job tracking, matching, and public jobs.
Resume-specific models live in api.models.resume / api.models.resume_v3.
"""
...
class MatchPreferences(BaseModel):
    ...
    location_tiers: Optional[list[str]] = None
